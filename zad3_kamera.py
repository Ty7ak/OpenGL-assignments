...
CONTROLS = "Sterowanie: \n" \
           ...
           "2 - obrót wokół osi x \n\n" \
           "r - reset widoku \n" \
           "lewy klawisz + ruch wyszką - poruszanie kamerą \n" \
...
#  funkcja odpowiadająca za rysowanie jaja
def egg():
...
#   funkcja odpowiadająca za obsługę przycisków myszki
def mouse(btn, state, x, y):
    global x_pos_old, y_pos_old, status
...
#  funkcja odpowiadająca za obsługę ruchów myszki
#  ! tylko z wciśniętym przyciskiem !
def motion(x, y):
...
#  funkcja odpowiadająca za obsługę ruchów kółka myszy
...
def render_scene():
    ...
    gluLookAt(viewer[0], viewer[1], viewer[2],
              ...
              view_angle[0], view_angle[1], view_angle[2])
    axes()

    if status == 1:
        view_point[0] += delta_x * 0.001
        view_point[1] -= delta_y * 0.001
